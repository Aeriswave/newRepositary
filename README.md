...
## 3. Решения
**Решение** (solution) - это комплекс модулей, создаваемых для достижения заявленных целей и решения поставленных задач   
**Продукт** (solution) - это набор модулей решения, используемых для создания системы        
**Модуль** (solution) - это компонент решения, обладающих определенным набором функционала           
### 3.1. Состав решения
