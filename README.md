...
**Уровень функционала** (level) - сгруппированный по определенным признакам функционал решения  
...
**Папки репозитария**  
**Комплекс решений** (complex) - комплексный инструментарий, состоящий из нескольких решения  
