...
>**2DEV** = версия в разработке, создание прототипа, разработка нового функционала  
>**2TST** = тестирование прототипа, функционала, совместимости  
...
>**0000** Базовый функционал (базовый набор функций и подсистем)  
