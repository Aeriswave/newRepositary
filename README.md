...
## 3. Решения
**Решение** (solution) - это комплекс модулей, совместимых между собой, имеющих взаимосвязанные планы развития и связанных межлу собой в единую группу, позволяющую создавать на основе модулей решения системы, обладающие функционалом включенных в него модулей    
**Продукт** (product) - это набор готовых модулей решения, используемых для создания типовой системы, не требующей доработки для создания типовой системы или требующей минимальной доработки и настройки для создания системы   
