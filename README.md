...
## Решения
**Решение** (solution)  
**Набор функционала** (pack)  
**Модули** (module)  
**Уровень функционала** (level)  
**Репозитарий** (repo)  
**Экосистема** (eco) включает в себя размещенный в хранилище репозитарий с документацией, инструментами, решением, финансировой информацией  
**Папки репозитария** ()  
**Комплекс решений** (complex)  
...
### Хранилище репозитария  
Место хранения копии репозитария (локальное или общее на сервере)
