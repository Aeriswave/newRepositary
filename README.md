...
### Репозитарий решения (локальный, общий)  
Папки репозитария  
Экосистема репозитария (документация, инструменты, исполнение, финансирование)     
Файлы репозитария  
Модули  
Функционал  
...
**Файл** - набор данных, сохраненных в файловой системе под одним именем.  
**Папка** - набор файлов, сохраненных в файловой системе под одним именем.  
**Файловая система** - набор папок и файлов.  
**Репозитарий** (repositary) - история изменений файлов, размещенных в папке репозитария и сгруппированных по версиям репозитария.  
**Папка репозитария** - папка файловой системы, содержащего репозитарий и файлы репозитария.  
**Снимок** (snapshot) или **Версия репозитария** - одна из сохраненных версий папки репозитария.  
...
**Указатель на ветвь** - это указатель на самую новый снимок в цепочке указателей ветви. При сохранении изменений в ветви репозитария сохраняется указатель на новую версию репозитария.  
...
**Объединение нескольких ветвей** (merge request) -  запрос на объединение файлов из снимков, относящихся к разным ветвям репозитария.  
