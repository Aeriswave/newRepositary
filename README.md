...
#### Правила создания описания и наполнения задач:  
#### Первичные исходные данные:  
>(1) Цель задачи  
>(2) Описание практического применения результата работ  
>(3) Документация и описания  
>(4) МетаДанные
#### Требования:  
>(1) Обозначить требования:  
>* к результату и функционалу  
>* к решению  
>* к составу работ  
>* к срокам исполнения  
>(2) Обозначить риски и неопределенности (изменение исходных данных, )  
>(3) Обозначить приоритеты в оптимизации задачи (качество, соблюдение сроков, бюджет, риски)  
#### Бюджет задачи  
>(1) Начальный  
>(2) Плановый  
