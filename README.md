...
#### (12) Тиражирование  
#### (13) Опт ими за ция  
#### (14) Перенос (иление, трясина)  
#### (15) Р а с ш и р е н и е  (потоп)  
#### (16) Нас (елен и е)  
#### (17) Приборы строения    
#### (19) Ад аптац и я  
...
>**5INF** = запрос на предоставление информации  
>**OK** = проверенная версия для использования  
>**7SUC** = история успеха  
>**8SUM** = итоги использования  
...
[1]   
#### (2) Разработка решения и создание прототипа       
#### (3) Тестирование решения и прототипа    
#### (7) Оптимизация и доработка решения   
#### (4) Выпуск работающей и протестированной версии (релиза)   
[2]   
#### (5) Сопровождение/техподдержка решения   
[3]
#### (6) Ипользование решения    
[4]
#### (8) Завершение разработки   
#### (9) Завершение продаж   
#### (10) Завершение сопровождения   
#### (11) Завершение финансирования   
#### (12) Завершение использования   
#### (13) Утилизация    
...
> 7SUC = история успеха (применение)    
> 8SUM = итоги  
> 9END  
