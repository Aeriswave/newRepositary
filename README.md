...
**НЕИндексируемый** файл репозитария - это список файлов и папок репозитария, для которых в репозитарии не применяется контроль версий (т.е. для всех версиях репозитария существует только одна версия такого файла).  
> В GIT Список таких файлов задается в файле ".gitignore"  
**Индексируемый** файл репозитария - это список файлов репозитария, для которых в репозитарии применяется контроль версий (т.е. для разных версий репозитария могут существовать более одной версии такого файла).  
...
**Добавление** (add) файлов и папок репозитарии в список .  
...
**Синхронизация** (fetch) локального репозитария с репозитарием хранилища - это получение отсутствующих данных репозитария из хранилища.  
