...
## Решения
**Экосистема решения** (eco) - включает в себя необходимые и достаточные на всех этапах жизненного цикла для разработки, использования, поддержки и утилизации решения:  
- ***документацию***  
- ***инструментарий***  
