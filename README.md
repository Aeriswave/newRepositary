...
## 3. Решения
**Решение** (solution) - это комплекс модулей, связанных межлу собой в единую группу, позволяющую создавать на их основе системы, обладающие заданным функционалом      
**Продукт** (product) - это набор модулей решения, используемых для создания типовой системы, не требующей доработки для создания типовой системы или требующей минимальной доработки для создания системы          
**Модуль** (module) - это компонент решения, обладающий определенным набором функционала           
### 3.1. Состав решения
...
(0) Название решения (solution) или системы (system)  
