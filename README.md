...
#### (2) Локальные НЕфинальные правки файлов (1 автор)  
>При сохранении в локальный репозитарий автора изменений: без ограничений  
>При сохранении в серверный репозитарий: не чаще 4 раз в сутки (утро, полдень, вечер, ночь)  
#### (3) Совместная работа над файлами (>1 автора)  
>Оптимальный вариант: при сохранении в общий репозитарий: не чаще 4 раз в сутки (утро, полдень, вечер, ночь)  
#### (4) Объединение ветвей   
>По необходимости  
#### (5) Выпуск новой версии  
>По необходимости  
#### (6) Обновление стабильной версии    
> По необходимости  
