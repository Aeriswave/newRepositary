...
### 1.3. План-график, Вехи (Milestones), сроки, группа задач и подзадач (состав работ) по проекту  
...
>
> В Redmine реализация интереснее: с диаграммами Ганта, связями между задачами, возможностью установить длительность   
...
**Релиз** (release) - версия, в которую далее запрещено вносить изменения, за исключением исправления ошибок   
...
#### Виды репозитариев  
**локальный** репозитарий - версия репозитария, доступная к просмотру и редактированию только одним пользователем (обычно хранится на компьютере пользователя).  
**общий** репозитарий - версия репозитария, доступная к просмотру и редактированию несколькими пользователями (обычно хранится на сервере).   
...
### 3.6. Этапы жизненного цикла решения (stage) в обозначениях версий     
...
> Планы на неделю, Халтура и Доделки по недоделкам, Внеплановые работы, Вечер неЗОЖ: пт   
