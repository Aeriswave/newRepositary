...
Интеграцию результата работ по задаче в соответствующую версию решения.  
...
**Запрос на объединение ветвей** (merge request) -  запрос на объединение файлов из последних версий снимков, относящихся к двум разным ветвям репозитария.  
