...
(4) Обозначить ограничения в оптимизации задачи (соблюдение качества, соблюдение сроков, соблюдение бюджета, учитывать определенные риски) 
(5) Обозначить приоритеты в оптимизации задачи (оптимизация качества, оптимизация сроков, оптимизация бюджета, риски) 
...
## 3. Решения
**Решение** (solution) - это система (инструментарий), создаваемый для достижения заявленных целей и решения поставленных задач, состоящий из модулей, обладающих определенным набором функционала     
### 3.1. Состав решения
...
> Оптимальный вариант: 2-3 раза в неделю (вечером в понедельник&среду | пн&вт&ср)  
>
