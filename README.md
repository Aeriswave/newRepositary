...
**Снимок** (snapshot) или **Версия** - одна из сохраненных версий папки репозитария.  
...
**Метка** (TAG) - именованный указатель на версию репозитария (аналогично ветви, но без обновления указателей на новые версии снимка)   
**Авторская метка** (aTAG) - это метка с указанием автора, его электронной почты, дату и комментарий     
**Подписанная авторская метка** (sTAG) - это авторска метка, подтвержденная "авторским секретным ключом" (GPG) 
